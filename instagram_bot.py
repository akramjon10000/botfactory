        ...
        try:
            ...
            with app.app_context():
                ...
                if not transcribed_text:
                    self.send_message(sender_id, "🎤 Ovoz xabari eshitilmadi yoki bo'sh. Iltimos, qaytadan urinib ko'ring.")
                    return False
                
                # Send transcription confirmation
                self.send_message(sender_id, f"🎤 Eshitildi: {transcribed_text}")
                ...
                try:
                    ...
                    history_entries = ChatHistory.query.filter_by(
                        bot_id=self.bot_id, 
                        user_telegram_id=str(sender_id)
                    ...
                    if not ai_response:
                        self.send_message(sender_id, "❌ Ovoz xabarini qayta ishlashda xatolik yuz berdi.")
                        return False
                    ...
                    logger.error(f"Instagram audio processing error: {e}")
                    self.send_message(sender_id, "❌ Ovoz xabarini qayta ishlashda xatolik yuz berdi.")
                    return False
